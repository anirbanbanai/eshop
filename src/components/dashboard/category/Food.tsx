...
const Food = () => {
  const products = [
    {
      ...
      stock: 120,
      imageUrl: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTbLjAdamssx0fDH1wozLg86hBqlS-JBO0si1R2ohuzdGRHG_6gpq8sTjc2TvzvzajnlfE&usqp=CAU",
      rating: 4.5,
    },
    {
      id: "2",
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 p-8 bg-white gap-y-4 rounded-primary lg:rounded-none lg:bg-transparent lg:p-0">
        ...
        <div className="grid grid-cols-1 gap-4 lg:grid-cols-4  md:grid-cols-3">
          {products.map((m) => (
            ...
            >
              ...
              <h2 className="text-sm">Price : <span className="font-semibold"> {m.price}$</span> </h2>
